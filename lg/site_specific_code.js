/**
 * Simon Rumble <simon.rumble@team.telstra.com> 20110121
 */

// Comment out the following line when moving to production
s.un = 'telstrabpmovieslgdev,telstrabpiptvdev';

// Uncomment the following line when moving to production
//s.un='telstrabpmovieslgprd,telstrabpiptvprd';

// DO NOT EDIT BELOW THIS LINE

// Use lgOmnitureBeacon() to write out all the Omniture stuff.
// lgOmnitureBeacon(coding standard, unique box identifier, page hierarchy);
// lgOmnitureBeacon(1, 'PBM3445X', 'LG|BigPond TV|Channel Listing|BigPond News');
function lgOmnitureBeacon(codingStandardVersion, boxIdent, pageHierarchy){
...
function lgOmnitureVideoPerformance(videoId, eventType, startTime, boxIdent){
	s.visitorID = sanitizeBoxIdent(boxIdent);
	s.eVar24 = boxIdent;
...
function lgOmnitureVideoPerformanceLiveChannelBeacon(videoId, boxIdent){
	// Still just a stub
	s.visitorID = sanitizeBoxIdent(boxIdent);
...
function lgOmnitureEvent(codingStandardVersion, boxIdent, trackEvent){
