...
//			Scene7Image.SetDimensions(_imageView.getMeasuredHeight(), _imageView.getMeasuredWidth());
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        TMMobile.tmTrackState("gallery:home", true, null);
        TMMobile.tmTrackState("gallery:home:2", null);

		TMMobile.tmTrackState("gallery:home2:isTMob:"+TMMobile.tmIsTelstraMobile(), null);


		HashMap<String, Object> contextData = new HashMap<String, Object>();
		contextData.put("kamal.carrier", TMMobile.tmGetCarrier());

		TMMobile.tmTrackState("gallery:home:kamal",contextData);


		TMMobile.tmTrackState("gallery:home:4", null);
		TMMobile.tmTrackState("gallery:home:5", null);
		TMMobile.tmTrackState("gallery:home:6", null);
		TMMobile.tmTrackState("gallery:home:7", null);
...
*/
	...
	public void showNextImage() {
		...
		updateImage();
        //kamal
        // add tracking for each image
        TMMobile.tmTrackState("gallery:home:next:" +_currentGalleryCounter, null);
    }
