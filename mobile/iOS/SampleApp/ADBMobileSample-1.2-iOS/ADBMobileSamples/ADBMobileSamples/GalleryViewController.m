...
- (void) viewDidLoad {
    ...
    NSMutableDictionary * scData = [NSMutableDictionary dictionary];
    [scData setObject:@"TID1234" forKey:@"user.telstraid"];
    //[TMMobile tmTrackState:@"gallery:home" subscribed:YES data:scData];
    
    [TMMobile tmLiveStreamTuneIn:@"video name"];
    [TMMobile tmLiveStreamKeepLive:@"video name"];
    [TMMobile tmLiveStreamTuneOut:@"video name" timePlayedSeconds:@"500"];
    
    [TMMobile tmTrackState:@"gallery:home" subscribed:YES data:nil];
    
    [TMMobile tmTrackState:@"gallery:home:2" data:nil];
    
    [TMMobile tmTrackState:[NSString stringWithFormat: @"gallery:home1:3:%@", TMMobile.tmIsTelstraMobile ? @"True" : @"False" ] data:nil];

    [TMMobile tmTrackState:@"gallery:home:4" data:nil];
    [TMMobile tmTrackState:@"gallery:home:5" data:nil];
    [TMMobile tmTrackState:@"gallery:home:6" data:nil];
    [TMMobile tmTrackState:@"gallery:home:7" data:nil];
...
- (void) updateGalleryItemInEngineeringView {
	...
	_lblProgress.text = [NSString stringWithFormat:@"%d of %lu", (int)_currentIndex+1, (unsigned long)kGalleryItemsCount];
