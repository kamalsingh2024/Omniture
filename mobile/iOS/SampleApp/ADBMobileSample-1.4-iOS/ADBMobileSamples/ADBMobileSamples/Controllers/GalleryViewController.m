...
- (void) viewDidLoad {
    ...
    //code added by Deyu starts
    NSMutableDictionary * scData = [NSMutableDictionary dictionary];
    [scData setObject:@"data value" forKey:@"user.test1.test2.test3"];
    [scData setObject:@"data value" forKey:@"user.test1.test5.test6"];
    [TMMobile tmTrackState:@"gallery:home" subscribed:YES data:scData];
    
    //Send the carrier name (if any)
    [scData setObject:[TMMobile tmGetCarrier] forKey:@"kamal.test2.carrierName"];
    [TMMobile tmTrackState:@"gallery:home:kamal" subscribed:YES data:scData];
