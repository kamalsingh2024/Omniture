...
- (void) viewDidLoad {
    ...
    [TMMobile tmTrackState:@"simple tracking:home" subscribed:YES data:nil];
...
- (IBAction) trackState {
    ...
    [TMMobile tmTrackState:@"Example State" subscribed:YES data:contextData];
}
...
- (IBAction) trackAction {
    ...
    [TMMobile tmTrackState:@"trackAction:data: button pushed" subscribed:YES data:contextData];
}
