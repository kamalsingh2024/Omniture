...
window.k_sc_param=window.k_sc_param||{version:1.1};var BP_SC=BP_SC||{};var s_account="telstrabpbigponddev";var s=s_gi(s_account);s.cookieDomainPeriods='3';if(window.location.host.indexOf(".com.au")!=-1){s.cookieDomainPeriods="3";}else{s.cookieDomainPeriods="2";}
s.dstStart="10/04/2015";s.dstEnd="04/03/2016";var tDate=new Date();s.currentYear=tDate.getFullYear();s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="javascript:,1seven.com.au,adelaidefilmfestival.org,afl.com.au,afl.footytips.com.au,afl.footytips.com.au,afl.virtualsports.com.au,aflmembership.com.au,anz-championship.com,aus.wwte8.com/pub/agent.dll,australianmasters.com.au,basic.messaging.bigpond.com,bbfdr.ticketek.com.au,beeneverywhere.com.au,bigblog.com.au,bigpond.cruises.com.au,bigpond.domain.com.au,bigpond.homepriceguide.com.au,bigpond.open.edu.au,bigpond.raisingchildren.net.au,bigpondeverest.com,bigpondgames.com,bigpondkids.com,bigpondmovies.com.au,bigpondmusic.com,bigpondnews.com,bigpondoffice.com.au,bigpondphotos.com,bigpondphotos.com.au,bigpondpilot.com.au,bigpondsecurity.com,bigpondshopping.com,bigpondsitehelp.com,bigpondsitehelp.com,bigpondsmsoffers.com.au,bigpondsport.com,bigpondsport.com.au,bigpondtelstrasearch.com,bigpondtickets.ticketek.com.au,bigpondtravel.com,bigpondtravel.com.au,bigpondtv.com,bigpondvideo.com,bigpondvideo.com.au,bluesfc.com.au,bombersfc.com.au,bpplanfinder.com,broncos.com.au,bulldogs.com.au,carltonfc.com.au,carltonfc.footytips.com.au,catsfc.com.au,centenaryofrugbyleague.com.au,christmas.bigpond.com,collingwoodfc.com.au,cowboys.com.au,ctones.telstra.com,downloads.bigpondmovies.com,dragons.com.au,dreamteam.nrl.com,dreamteam.nrl.com,dreamteampro.virtualsports.com.au,dvd.bigpondmovies.com,files.bigpond.com,files.bigpond.com,fremantlefc.com.au,gamearena.com.au,gamenow.com.au,geelongcats.com.au,gfc.com.au,girlfriday.tv,go.bigpond.com,goldcoastfc.com.au,hawthornfc.com,hawthornfc.com.au,hm.bigpond.com,hm.bigpondnews.com,horseracing.bigpond.com,horseracing.bigpondsport.com,iad.bigpondvideo.com,kangaroos.com.au,lions.com.au,magpiesfc.com.au,manlyseaeagles.com.au,melbournefc.com.au,melbournestorm.com.au,memberoffers.bigpond.com,messaging.bigpond.com,mobilefun.telstra.com,myacct.bigpond.com,newcastleknights.com.au,newzealandwarriors.co.nz,newzealandwarriors.com.au,nrl.com,nrl.com.au,nrl.virtualsports.com.au,nrlfinals.virtualsports.com.au,nrlwarriors.com,nswrl.com.au,parraeels.com.au,penrithpanthers.com.au,planetteal.com.au,portadelaidefc.com.au,portadelaidefc.footytips.com.au,portpowerfc.com.au,promo.bigpond.com,qrl.com.au,raiders.com.au,richmondfc.com.au,saints.com.au,say.bigpond.com,search.api.bigpond.com,sharks.com.au,shop.bigpond.com,shop.bigpondgames.com,signon.bigpond.com,storage.bigpond.com,sydneyroosters.com.au,sydneyswans.com.au,sydneysymphony.bigpondmusic.com,telstra.com,thenews.bigpond.com,thewarriors.co.nz,thewarriors.com.au,thub.bigpond.com,tipping.afl.com.au,tipping.nrl.com,titans.com.au,westcoasteagles.com.au,150years.com.au,afl.virtualsports.com.au,bigpond.custhelp.com,bigpondguide.com,westcoasteagles.footytips.com.au,westernbulldogs.com.au,weststigers.com.au,deezone.com.au,itsyourcall.afl.com.au,lifestylefood.com.au,lifestyle.com.au,skynews.com.au,racingnetwork.com.au,giantsacademy.com.au,sportsfan.com.au,tradingpost.com.au,carshowroom.com.au,aflmedia.championdata.com,tickets.nrl.com,airg.com,.airg.com";BP_SC.linkInternalFilters=s.linkInternalFilters;s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=true;function s_doPlugins(s){if(s.linkInternalFilters!==BP_SC.linkInternalFilters){s.linkInternalFilters=BP_SC.linkInternalFilters;}
s.tnt=s.trackTNT();s.events=s.apl(s.events,"event27",",",1);if(s.getQueryParam('cid')){s.eVar7=s.getQueryParam('cid');}
if(s.getQueryParam('sssdmh')){s.eVar8=s.getValOnce(s.getQueryParam('sssdmh'),'sssdmhmp_cookie',1);s.eVar45=s.getQueryParam('dmid');}else if(s.getQueryParam('pid')){s.eVar8=s.getValOnce(s.getQueryParam('pid'),'pmp_cookie',1);s.clickThruQuality('pid','event25','event26');}
if(s.getQueryParam('ref')){s.eVar13=s.getQueryParam('ref');s.prop47=s.getQueryParam('ref');}
s.eVar39=s.getValOnce(s.getQueryParam('gcid'),'gcmp_cookie',1);s.eVar49=s.getValOnce(s.getQueryParam('track_id'),'rmp_cookie',1);if(s.getQueryParam('sio')){s.eVar26=s.getValOnce(s.getQueryParam('sio'),'smp_cookie',1);}
if(s.getQueryParam('s_kwcid')){s.pageURL=s.manageQueryParam('s_kwcid',0,1);s.eVar8=s.getValOnce(s.getQueryParam('s_kwcid'),'pmp_cookie',1);s.clickThruQuality('s_kwcid','event25','event26');}
if(window.s_postPlugins){s_postPlugins(s);}
s.prop33=s.getTimeParting('h','+10');s.prop34=s.getTimeParting('d','+10');s.prop35=s.getTimeParting('w','+10');s.eVar40=s.getTimeParting('h','+10');s.eVar41=s.getTimeParting('d','+10');s.eVar42=s.getTimeParting('w','+10');s.prop46=s.getNewRepeat();s.eVar46=s.getNewRepeat();if(s.pageName!=""){s.prop48=s.getPreviousValue(s.pageName,'gpv_e48','');s.eVar43=s.getPreviousValue(s.pageName,'gpv_p43','');}
if(s.prop3!=""){s.prop49=s.getPreviousValue(s.prop3,'gpv_p49','');}
if(s.eVar3!=""){s.eVar44=s.getPreviousValue(s.eVar3,'gpv_e44','');}
if(s.pageName!=""){var ppv=s.getPercentPageViewed(s.pageName);if(ppv&&typeof ppv=='object'&&ppv[0]==s.prop48){s.prop16=ppv[1]+'|'+ppv[2];}}
s.eVar18=s.crossVisitParticipation(s.eVar8,'s_evar18','30','10','>','');s.clickThruQuality('pid','event25','event26');if(s.prop3!=='BP_SC.com'&&s.prop3!==undefined&&s.prop3!=='Internet'){s.eVar26=s.prop3;}
if(document.location.protocol==='https:'){s.events=s.apl(s.events,"event40",",",1);}else{s.events=s.apl(s.events,"event41",",",1);}
if(s.pageName==='BP|News|Weather|Current:Home'){s.pageName='BP:News:Weather:Current:Home'}
if(s.getQueryParam('tc')){s.eVar8=s.getValOnce(s.getQueryParam('tc'),'pmp_cookie',1);s.clickThruQuality('tc','event25','event26');BP_SC.datCreateOmnitureBeacon('',s.getQueryParam('tc'));}
if(typeof(s.hier1)!=='undefined'){BP_SC.hierarchy=s.hier1.split('|');switch(BP_SC.hierarchy[2]){case"Health":BP_SC.addReportSuite('telstrabphealth');break;}}
var reportSuites=s.un.split(',');reportSuites.reverse();if(reportSuites.indexOf("telstraglobalprd")==-1&&s.un.indexOf("prd")>0){reportSuites.push("telstraglobalprd");}
s.un=reportSuites.join(',');if(s.hier1==='BP|Services|RAA|DefaultLogin'){s.hier1='BP|Portal|Login';s.pageName='BP|Login';s.prop2=s.eVar2='Portal';s.prop3=s.eVar3='Login';s.channel=s.eVar4='';}
if(s.hier1==='BP|Sport|NRL|NRL.com|DigitalPass|DigitalPass Voucher '){s.hier1='BP|Sport|NRL|NRL.com|DigitalPass|Marketing';s.pageName='BP:NRL:NRL.com:DigitalPass:Marketing';s.prop1='BP';s.prop2='Sport';s.prop3='NRL';s.channel="NRL.com";s.prop4="DigitalPass";s.prop5="Marketing";s.eVar1=s.prop1;s.eVar2=s.prop2;s.eVar3=s.prop3;s.eVar4=s.channel;s.eVar5=s.prop4;s.eVar15=s.prop5;}}
s.doPlugins=s_doPlugins;BP_SC.datCreateOmnitureBeacon=function(events,campaign){var prefix='https://infos.telstra.com/b/ss/telstratdretailprd/1/H.27.5/';prefix+=parseInt(Math.random()*9999999999,10);prefix+='?AQB=1&ndh=1&ns=telstracorporation&cdp=3';var suffix='&g='+escape(document.location.href)+'&c8=D%3Dg&AQE=1';if(events){events='&events='+escape(events);}else{events='';}
if(campaign){campaign='&v0='+escape(campaign);}else{campaign='';}
var beaconUrl=prefix+events+campaign+suffix;BP_SC.datAdServer('<img height="1" width="1" style="border-style:none;" alt="" src="'+beaconUrl+'" alt="" />');};BP_SC.addReportSuite=function(rsidStem){if((s.un.search(/rsidStem/)===-1)&&(s_account.search(/rsidStem/)===-1)){if((s.un.search(/telstrabpbigponddev/)!==-1)||(s_account.search(/telstrabpbigpondprd/)!==-1)){var rsidType='prd';}else{var rsidType='dev';}
s.un=s.un+','+rsidStem+rsidType;}}// Plugins
...
s.Media.trackVars="events,eVar64,contextData.channelname,contextData.classification,contextData.collection,contextData.contentprovider,contextData.contenttitle,contextData.aspectratio,contextData.site,contextData.drmprotected,contextData.videoURL";
...
var s_userDataCookie = s_readCookie('s_c20');

if (s_userDataCookie.length > 0) {
    s.eVar73 = s_userDataCookie;
    s.contextData['s_userDataCookie'] = s_userDataCookie.match(/;cn=(.*);/)[1];  
	...
	s_setCookie('s_c20', encodeURIComponent(extraAdCallInfo));
	s.eVar73 = extraAdCallInfo;
    s.contextData['s_userDataCookie'] = extraAdCallInfo.match(/;cn=(.*);/)[1];
}
// AAM Integration (DIL)
...
/* Adobe Workbench Integration Code */
s.aamDil = DIL.create({
	partner : "telstra",
	uuidCookie:{
	name:'aam_uuid',
...
s.aam_uuid_process = function(){
	if (s.getVisitStart("s_visit")==1 && typeof (arguments[0].uuid) != "undefined" && arguments[0].uuid != "") {
	//console.log("test" + arguments[0].uuid);
	s.linkTrackVars = "contextData.aam.uuid";
	s.contextData['aam.uuid'] = arguments[0].uuid; s.tl(true,'o','track aam uuid',null,'navigate');
	}
}
s.aamDil.api.signals({}).afterResult(s.aam_uuid_process).submit();
