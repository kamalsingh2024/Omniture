/* SiteCatalyst code version: H.20.2. - V7.2 - 200610 Copyright 1997-2009 Omniture, Inc. More info available at http://www.omniture.com */
var s_account="telstraglobalprd,telstrabpbigpondprd";var s=s_gi(s_account);s.cookieDomainPeriods='3';if(window.location.host.indexOf(".com.au")!=-1){s.cookieDomainPeriods="3";}else{s.cookieDomainPeriods="2";}s.dstStart="10/04/2009";s.dstEnd="04/04/2010";var tDate=new Date();s.currentYear=tDate.getFullYear();s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";
s.linkInternalFilters="javascript:";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=true;function s_doPlugins(s){if(window.s_postPlugins){s_postPlugins(s);}
s.prop33=s.getTimeParting('h','+10');s.prop34=s.getTimeParting('d','+10');s.prop35=s.getTimeParting('w','+10');s.eVar40=s.getTimeParting('h','+10');s.eVar41=s.getTimeParting('d','+10');s.eVar42=s.getTimeParting('w','+10');s.prop46=s.getNewRepeat();s.eVar46=s.getNewRepeat();s.prop48=s.getPreviousValue(s.pageName,'gpv_e48','');s.eVar43=s.getPreviousValue(s.pageName,'gpv_p43','');s.prop49=s.getPreviousValue(s.prop3,'gpv_p49','');s.eVar44=s.getPreviousValue(s.eVar3,'gpv_e44','');}
s.doPlugins=s_doPlugins;s.loadModule("Media");s.Media.autoTrack=false;s.Media.trackWhilePlaying=true;s.Media.trackVars="None";s.Media.trackEvents="None";s.loadModule("Integrate");s.visitorNamespace="bigpond";s.trackingServer="info.telstra.com";s.trackingServerSecure="infos.telstra.com";s.dc="122";
...
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");s.getNewRepeat=new Function(""
+"var s=this,e=new Date(),cval,ct=e.getTime(),y=e.getYear();e.setTime"
+"(ct+30*24*60*60*1000);cval=s.c_r('s_nr');if(cval.length==0){s.c_w("
+"'s_nr',ct,e);return 'New';}if(cval.length!=0&&ct-cval<30*60*1000){s"
+".c_w('s_nr',ct,e);return 'New';}if(cval<1123916400001){e.setTime(cv"
+"al+30*24*60*60*1000);s.c_w('s_nr',ct,e);return 'Repeat';}else retur"
+"n 'Repeat';");s.manageVars=new Function("c","l","f",""
...
+"if(t=='d'){return dow};if(t=='w'){return dt}}};");s.join=new Function("v","p",""
...
+")+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v");s.manageQueryParam=new Function("p","w","e","u",""
...
+"(b)qs='?'+qp+'&'+b;else qs='?'+qp;return u+qs");s.m_Media_c="(`OWhilePlaying~='s_media_'+m._in+'_~unc^D(~;`E~m.ae(mn,l,\"'+p+'\",~){var m=this~o;w.percent=((w.off^e+1)/w`X)*100;w.percent=w.percent>1~o.'+f~=new ~o.Get~:Math.floor(w.percent);w.timeP"
